...
const columns = [
  {
    title: <span className="text-ele">ACTION NAME</span>,
  ...
  },
  {
    ...
    className: 'bg-transparent text-gray-6',
    render: text => {
      return <a className="text-blue text-ele">{text}</a>
    },
  },
  {
    title: <span className="text-ele">PTHONE</span>,
    dataIndex: 'phone',
    key: 'phone',
    className: 'text-left text-gray-6 bg-transparent',
  },
  {
    title: <span className="text-ele">VALUE</span>,
    dataIndex: 'value',
    key: 'value',
    className: 'text-right bg-transparent text-gray-6',
    render: text => <span className="font-weight-bold text-ele">{text}</span>,
  },
]
